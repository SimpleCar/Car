...
*/
		...
		(function($){
			var SelCar = function(ele,options){
		        ...
		        this.loadBrandsUrl = this.opts.BrandsUrl || 'http://api.chedai.bitauto.com/api/Common/GetCarMasterBrandListWithFirstLetter';
		        this.loadSerialsUrl = this.opts.SerialsUrl || 'http://api.chedai.bitauto.com/api/Common/GetCarSerialListWithBrand?masterBrandId=';
		        this.loadCarsUrl = 'http://api.chedai.bitauto.com/api/Common/GetCarListWithPrice?serialId=';
			...
			SelCar.prototype = {
		        ...
		        renderDom:function(){
		        	var self =  this;
		        	self.element.wrap('<span class="sel-car-wrapper"></span>');
