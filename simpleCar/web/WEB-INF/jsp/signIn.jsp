...
<div class="shortcut">
    <div class="w1200 clearfix">
        ...
        <div class="back-home float-l">
            <a href="//www.taoche.com/" title="淘车-腾讯京东百度易车共同投资的互联网汽车交易平台" class="back-link"
        ...
        <ul class="clearfix shortcut_info float-r">
            ...
            <li id="tc_top_liMyDealer" class="my-sj">
                ...
                <div class="my-seller-menu" id="tc_top_myDealerList">
                    ...
                    <a href="//dealer.taoche.com/account/register/" target="_blank"
            ...
            <li id="tc_top_liAppDownload" class="app-down">
                ...
                <div class="my-app-down" id="tc_top_appDownloadList">
                    <a href="//www.taoche.com/download/taocheapp/" target="_blank" rel="nofollow"
    ...
    <div class="w1200">
        <div class="logo">
            <a href="//www.taoche.com" title="淘车网">
                ...
                <![endif]-->
                <!--[if !IE]><!-->
                <img src="//img1.yixinfinance.com/taoche/common/images/taoche-logo.svg" width="102" height="76"
                     alt="淘车">
                <!--<![endif]-->
            </a>
        </div>
        ...
        <div class="search clearfix">
            ...
            <input type="text" id="tc_search_txtNewcar" name="tc_search_txtNewcar" autocomplete="off"
                   placeholder="请输入心仪的品牌或车型"/>
...
<div class="nav_menu">
    <ul id="ul_menu" class="area clearfix">
        ...
        <li data-menu="ershouche" id="tc_top_liMenuErshouche">
            <a id="tc_top_menuErshouche" href="//beijing.taoche.com/all/" class="link sub" logwt="navigation_usedcar"
               _islog="1">
                <span>二手车</span>
            </a>
            <em class="spacer"></em>
