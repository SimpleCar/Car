...
<link rel="stylesheet" type="text/css" href="../../statics/css/carInsurance/2018_pc_headfoot_style-20180305102257-1506.css" media="all" />
            ...
            <li id="tc_top_liAppDownload" class="app-down">
                ...
                <div class="my-app-down" id="tc_top_appDownloadList">
                    <a href="//www.taoche.com/download/taocheapp/" target="_blank" rel="nofollow" logwt="navigation_header_app_ersc">
                        淘车
                        <div class="scan-code">
                            <img src="../../statics/image/carInsurance/scan-code.png" alt="" />
                        </div>
                    </a>
    ...
    <div class="w1200">
        <div class="logo">
            <a href="//www.taoche.com" title="淘车网">
                <!--[if IE]>
                <img src="../../statics/image/carInsurance/taoche-logo.png" width="102" height="76" alt="淘车"/>
                <![endif]-->
                <!--[if !IE]><!-->
                <img src="../../statics/image/carInsurance/taoche-logo.svg" width="102" height="76" alt="淘车">
                <!--<![endif]-->
            </a>
        </div>
        <!-- city-hover -->
