...
<script>
    var arrImg = ['../../statics/single/car-001.png',
      '../../statics/single//images/car-002.png',
          '../../statics/single/car-003.png',
          '../../statics/single/car-004.png',
          '../../statics/single/images/car-005.png',
...
<article class="user_nav_box" id="userLeft">
    <div class="user_photo_box">
        <div class="user_photo">
            <img src="../../statics/single/images/user_photo_bg.html.png" class="user_photo_bg" />
            <span class="bg_txt">点我换一个</span>
                <img src="../../statics/single/car-008.png" class="photo" />
        </div>
    ...
    <nav class="user_nav">
        <ul class="user_ul">
            ...
            <li class="cur"><a href="/User/ViewUserProfile">个人资料<i class="tip_r"></i></a></li>            
            <li class=""><a href="/User/ViewQualification">信用信息<i class="tip_r"></i></a></li>
    ...
    <div class="QRCode_box clrfix box-sizing hide">
        <aside class="fl QRCode">
            <img src="../../statics/single/qrcode.png">
        </aside>
