...
<head>
    ...
    <script type="text/javascript">
        ...
        var ImgValidateCodeUrl = '/Register/GetImageValidateCode';
    </script>
...
<div class="shortcut">
    <div class="w1200 clearfix">
        ...
        <div class="back-home float-l">
            <a href="https://www.taoche.com/" title="淘车-腾讯京东百度易车共同投资的互联网汽车交易平台" class="back-link"
        ...
        <ul class="clearfix shortcut_info float-r">
            ...
            <li id="tc_top_liMyDealer" class="my-sj">
                ...
                <div class="my-seller-menu" id="tc_top_myDealerList">
                    ...
                    <a href="https://dealer.taoche.com/account/register/" target="_blank"
            ...
            <li id="tc_top_liAppDownload" class="app-down">
                ...
                <div class="my-app-down" id="tc_top_appDownloadList">
                    <a href="https://www.taoche.com/download/taocheapp/" target="_blank" rel="nofollow"
                       logwt="navigation_header_app_ersc">
                        淘车
                        <div class="scan-code">
                            <img src="./快速注册_files/scan-code.png" alt="">
                        </div>
                    </a>
                    <a href="https://xin.taoche.com/app/download/" target="_blank" rel="nofollow">淘车新车</a>
                    <a href="https://app.yiche.com/taoche/" target="_blank" rel="nofollow"
                       logwt="navigation_header_app_ersc">淘车二手车</a>
                    <a href="https://www.daikuan.com/app/" target="_blank" rel="nofollow">易鑫车贷</a>
                </div>
            </li>
            <li class="yx-zp">
                <a rel="nofollow" target="_blank" href="https://job.yxqiche.com/" title="易鑫招聘"
                   class="info-link">易鑫招聘</a>
            </li>
        </ul>
    </div>
</div>
    ...
    <div class="w1200">
        <div class="logo">
            <a href="https://www.taoche.com/" title="淘车网">
                ...
                <![endif]-->
                <!--[if !IE]><!-->
                <img src="./快速注册_files/taoche-logo.svg" width="102" height="76" alt="淘车">
                <!--<![endif]-->
            </a>
        </div>
        <!-- city-hover -->
...
<div class="nav_menu">
    <ul id="ul_menu" class="area clearfix">
        ...
        <li data-menu="ershouche" id="tc_top_liMenuErshouche">
            <a id="tc_top_menuErshouche" href="https://guangzhou.taoche.com/all/" class="link sub"
